...
| public | [jsonSerialize()](../classes/YooKassa-Model-Receipt-ReceiptItemAmount.md#method_jsonSerialize) |  |  |
...
| ---- | ---- | ----------- |
| <code lang="php">array OR numeric-string OR int OR float OR null</code> | value  | Сумма |
